...
class EquipamentosControllerTest < ActionController::TestCase
  ...
  test "should create equipamento" do
    assert_difference('Equipamento.count') do
      post :create, equipamento: { descricao: @equipamento.descricao, fornecedor: @equipamento.fornecedor, info: @equipamento.info, marca: @equipamento.marca, modelo: @equipamento.modelo, potencia: @equipamento.potencia, tipo: @equipamento.tipo }
    end
  ...
  test "should update equipamento" do
    patch :update, id: @equipamento, equipamento: { descricao: @equipamento.descricao, fornecedor: @equipamento.fornecedor, info: @equipamento.info, marca: @equipamento.marca, modelo: @equipamento.modelo, potencia: @equipamento.potencia, tipo: @equipamento.tipo }
    assert_redirected_to equipamento_path(assigns(:equipamento))
  end
